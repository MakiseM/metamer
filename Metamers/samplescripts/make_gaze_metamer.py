...
for i in range(500):
    generate_image_schedule('../sampleimages/EIN.jpg', OurGazeWarpSched, color=True, max_iters=iters, basename='cat')

    target_file = './poolstatmetamer_output/cat_gazemet.png'
    weights_file = './weights.txt'
    rename_and_delete_weights_file(target_file, weights_file)
    print(f"Completed iteration {i + 1}/100")
